...
{
    return Vector4(
        vec.x * mat.mat[0][0] + vec.y * mat.mat[1][0] + vec.z * mat.mat[2][0] + vec.w * mat.mat[3][0],
        vec.x * mat.mat[0][1] + vec.y * mat.mat[1][1] + vec.z * mat.mat[2][1] + vec.w * mat.mat[3][1],
        vec.x * mat.mat[0][2] + vec.y * mat.mat[1][2] + vec.z * mat.mat[2][2] + vec.w * mat.mat[3][2],
        vec.x * mat.mat[0][3] + vec.y * mat.mat[1][3] + vec.z * mat.mat[2][3] + vec.w * mat.mat[3][3]
        );
}
